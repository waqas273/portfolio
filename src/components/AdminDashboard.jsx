...
export default function AdminDashboard() {
  ...
  const pitchPresets = [
    ...
    },
    {
      ...
      body: `Dear Management Team at {company},\n\nI recently reviewed {company}'s educational presence and wanted to reach out regarding modernizing your web platform into a custom School & College Management Portal.\n\nI am Muhammad Waqas, a Full-Stack Software Engineer. I specialize in building custom, high-performance web applications and portal systems for educational institutions to manage administrative records, fee tracking, and academic workflows.\n\nHere is a general overview of the modules and records system I can build for {company}:\n- 💵 Accountant Fee Status & Record Manager: No online payment gateway needed. Fees are paid as usual, and the Accountant updates the student's status (Paid / Pending / Overdue) with permanent digital record tracking and fee vouchers.\n- 👥 Student & Parent Individual Accounts: Dedicated login accounts for parents and students to check attendance records, exam results, and fee status.\n- 📝 Digital Admissions & Class Directory: Online application forms, student document records, roll number assignments, and class section lists (Classes 1-10).\n- 🔒 Role-Based Access Control: Tailored access for Super Admin, Principal, Accountant, Teacher, Student, and Parent accounts.\n- 💼 Staff & Job Openings Portal: Career portal for teacher job applications and staff management records.\n- 🎓 Scalable College LMS: Future-ready Learning Management System (lecture notes, assignments, grading) for when {company} expands into College level.\n\nYou can inspect my verified software developer portfolio and live web projects here: https://iwaqass.xyz/\nView full web proposal: https://iwaqass.xyz/Rai_Education_System_Proposal.html\n\nWould you be open to a brief 10-minute demonstration or prototype review this week to see how we can digitize {company}'s records?\n\nBest regards,\nMuhammad Waqas\nFull-Stack Software Engineer\nPortfolio: https://iwaqass.xyz/\nGitHub: https://github.com/waqas273`
    }
  ];
